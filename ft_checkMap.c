...
/*   Updated: 2021/07/15 16:15:52 by qbrillai         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_checkMap3(t_game *game)
{
	...
	{
		if (game->map[row][0] != 1 && game->map[row][0] != 9 && game->map[row][0] != 0)
			return (0);
		...
		col--;
		if (game->map[row][col] != 1 && game->map[row][col] != 9 && game->map[row][0] != 0)
			return (0);
		col = 0;
		row++;
	}
